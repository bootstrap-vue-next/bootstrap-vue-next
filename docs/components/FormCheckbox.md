...
<div class="bg-danger p-2" style="--bs-bg-opacity: .5;" >
<strong>Be cautious</strong> of placing user supplied content in the `html` field, as it may make you vulnerable to <strong>XSS attacks</strong>, if you do not first sanitize the user supplied string.
</div>
