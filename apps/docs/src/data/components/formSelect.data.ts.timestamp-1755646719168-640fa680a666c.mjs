...
// src/data/components/formSelect.data.ts
var optionSlot = {
  option: {
    description:
    ...
    scope: {
      ...
      disabled: {
        ...
        // TODO grammar check (should end with a period for consistency with other descriptions)
      },
    },
  },
}
var formSelect_data_default = {
  load: () => ({
    BFormSelect: {
      styleSpec: {kind: 'TAG' /* Tag */, value: 'select'},
      ...
      props: {
        ...
        selectSize: {
          ...
          // TODO grammar check (should say "browsers" instead of "browser")
        },
      },
      emits: {
        'update:model-value': {
          ...
          // TODO similar content to BFormRadioGroup/update:model-value (identical description)
          args: {
            value: {
    ...
    BFormSelectOption: {
      styleSpec: {kind: 'TAG' /* Tag */, value: 'option'},
    ...
    BFormSelectOptionGroup: {
      styleSpec: {kind: 'TAG' /* Tag */, value: 'optgroup'},
