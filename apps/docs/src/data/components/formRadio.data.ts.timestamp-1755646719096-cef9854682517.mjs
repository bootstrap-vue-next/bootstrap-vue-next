...
// src/data/components/formRadio.data.ts
var formRadio_data_default = {
  load: () => ({
    BFormRadio: {
      styleSpec: {kind: 'TAG' /* Tag */, value: 'input[type="radio"]'},
      ...
      emits: {
        'update:model-value': {
          ...
          // TODO similar content to BFormCheckbox/update:model-value (similar purpose)
          args: {
            value: {
    ...
    BFormRadioGroup: {
      styleSpec: {kind: 'TAG' /* Tag */, value: 'dev[role="radiogroup"]'},
      // TODO grammar check (typo: "dev" should likely be "div")
      ...
      props: {
        ...
        buttons: {
          ...
          // TODO grammar check (typo: "renderes" should be "renders")
        },
        modelValue: {
          type: 'RadioValue | undefined',
          default: void 0,
      ...
      emits: {
        'update:model-value': {
          ...
          // TODO similar content to BFormCheckboxGroup/update:model-value (identical description)
          args: {
            value: {
