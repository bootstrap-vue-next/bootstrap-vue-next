...
// src/data/components/spinner.data.ts
var spinner_data_default = {
  load: () => ({
    BSpinner: {
      styleSpec: {kind: 'OVERRIDE-CLASS' /* OverrideClass */, value: '.spinner-*'},
