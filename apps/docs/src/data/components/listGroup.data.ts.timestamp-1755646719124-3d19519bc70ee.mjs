...
// src/data/components/listGroup.data.ts
var listGroup_data_default = {
  load: () => ({
    BListGroup: {
      ...
      props: {
        ...
        horizontal: {
          ...
          // TODO item not in string format
          description:
            'When set, renders the list group horizontally rather than the default vertical',
          // TODO grammar check (should say "default of vertical" instead of "default of vertical" for clarity)
        },
        numbered: {
          type: 'boolean',
          default: false,
