...
// src/data/components/formFile.data.ts
var formFile_data_default = {
  load: () => ({
    BFormFile: {
      ...
      props: {
        ...
        capture: {
          ...
          // TODO grammar check (should say "instruct" instead of "instruction"; "devices" should be "device's")
        },
        directory: {
          type: 'boolean',
          default: false,
        ...
        noButton: {
          ...
          // TODO grammar check (should capitalize "Hide" for consistency)
        },
        noDrop: {
          type: 'boolean',
          default: false,
        ...
        noTraverse: {
          ...
          // TODO grammar check (typo: "Wether" should be "Whether"; "returns" should be "return")
        },
      },
      emits: {
        'update:model-value': {
