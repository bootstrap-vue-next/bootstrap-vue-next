...
// src/data/components/formSpinbutton.data.ts
var formSpinbutton_data_default = {
  load: () => ({
    BFormSpinbutton: {
      ...
      props: {
        ...
        locale: {
          ...
          // TODO grammar check (should say "locale" instead of "local")
        },
        max: {
          type: 'Numberish',
          default: '100',
        ...
        repeatDelay: {
          ...
          // TODO grammar check (awkward phrasing: "after before" should be "before")
        },
        repeatInterval: {
          type: 'Numberish',
          default: '100',
        ...
        wrap: {
          ...
          default: 'false',
          description: 'When set, renders the component with a vertical layout',
          // TODO grammar check (description identical to `vertical`, likely incorrect; should describe wrapping behavior)
        },
        modelValue: {
          // TODO missing description
          // TODO missing type
      ...
      emits: {
        ...
        'update:model-value': {
          ...
          // TODO similar content to BFormInput/update:model-value (similar purpose)
          args: {
            value: {
              type: 'number | null',
              description: 'Currently value of the spinbutton control.',
