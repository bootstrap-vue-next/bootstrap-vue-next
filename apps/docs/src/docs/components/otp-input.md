...
By default, `BOtpInput` renders 6 input fields. Use the `length` prop to customize the number of fields.
...
By default, `BOtpInput` accepts any alphanumeric character. This is the default `type="text"` mode.
...
<<< DEMO ./demo/OtpInputNumeric.vue#template{vue-html}
...
<<< DEMO ./demo/OtpInputOtp.vue#template{vue-html}
