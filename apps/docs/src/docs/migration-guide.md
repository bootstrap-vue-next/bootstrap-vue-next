...
✅ **No changes needed** - The `v-b-toggle` directive syntax is fully compatible.
...
See the [Toggle Directive documentation](/docs/directives/BToggle) for complete details.
