...
const computedAriaInvalid = computed<'grammar' | 'spelling' | boolean | undefined>(() => {
  if (props.ariaInvalid === true || props.ariaInvalid === false) {
...
const formOptions = computed<any>(() =>
  normalizeOptions(props.options as any, 'BFormSelect', props)
)
...
// methods
// TODO this may not properly be working. Input may be undefined
const focused = (): void => {
