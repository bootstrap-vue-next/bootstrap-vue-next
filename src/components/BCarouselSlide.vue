<template>
    <div class="carousel-item" :class="{ active }" :style="{
                background: 'rgb(171, 171, 171) none repeat scroll 0% 0%',
            }">
        <slot name="img">
            <img class="d-block w-100" :src="img" :width="imgWidth || width" :height="imgHeight || height" />
        </slot>
...
export default defineComponent({
    ...
    setup(props) {
        ...
        const img = computed(() => {
            return props.imgBlank ? imgBlank : props.imgSrc;
        })
