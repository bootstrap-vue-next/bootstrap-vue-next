...
<template>
  <b-container id="container" ref="container" :toast="{root: true}" class="mt-4" fluid="sm">
    <b-form-select v-model="testingVal" :options="testingObj" />
    <!-- Form -->
    <template v-if="testingVal === 'Form'">
      <div class="my-2">
        <h2>Form</h2>
      ...
      <div class="my-2">
        ...
        <div class="mt-2">
          ...
          <div class="row mb-1">
            <div class="col-1 mb-1">small</div>
            <b-form-input type="text" size="sm" class="col" />
          </div>
          <div class="row mb-1">
            <div class="col-1">large</div>
        ...
        <div class="mt-2">
          ...
          <div class="row mb-1">
            ...
            <b-form-input type="text" :state="null" class="col" />
          </div>
          <div class="row mb-1">
    ...
    <!-- Navigation -->
    <template v-else-if="testingVal === 'Navigation'">
      <div class="my-2">
    ...
    <!-- Badge -->
    <template v-else-if="testingVal === 'Badge'">
      <div class="my-2">
        <h2>Badge</h2>
        <div>
          <h4>Simple</h4>
    ...
    <!-- Dropdown -->
    <template v-else-if="testingVal === 'Dropdown'">
      <div class="my-2">
    ...
    <!-- Cards -->
    <template v-else-if="testingVal === 'Cards'">
      <div class="my-2">
    ...
    <!-- Tabs -->
    <template v-else-if="testingVal === 'Tabs'">
      <div class="my-2">
    ...
    <!-- Layout -->
    <template v-else-if="testingVal === 'Layouts'">
      <div class="my-2">
        <h2>Layout</h2>
        <div>
    ...
    <!-- Alerts -->
    <template v-else-if="testingVal === 'Alerts'">
      <div class="my-2">
        <h2>Alerts</h2>
    ...
    <!-- Avatars -->
    <template v-else-if="testingVal === 'Avatars'">
      <div class="my-2">
        <div>
          <h2>Avatars</h2>
    ...
    <!-- Image -->
    <template v-else-if="testingVal === 'Image'">
      <div class="my-2">
        <h2>Image</h2>
    ...
    <!-- Breadcrumb -->
    <template v-else-if="testingVal === 'Breadcrumb'">
      <div class="my-2">
        <h2>Breadcrumb</h2>
        <b-breadcrumb />
      </div>
    ...
    <!-- Table -->
    <template v-else-if="testingVal === 'Table'">
      <div class="my-2">
        <h2>Table</h2>
        <div>
          <h4 class="my-3">Table without field definitions</h4>
          <b-button @click="tableBusy = !tableBusy">Toggle busy</b-button>
          <b-table
            responsive="xs"
    ...
    <!-- Accordion -->
    <template v-else-if="testingVal === 'Accordion'">
      <div class="my-2">
    ...
    <!-- Carousel -->
    <template v-else-if="testingVal === 'Carousel'">
      <div class="my-2">
        <h2>Carousel</h2>
    ...
    <!-- Modal -->
    <template v-else-if="testingVal === 'Modal'">
      <div class="my-2">
        <h2>Modal</h2>
    ...
    <!-- Tooltip -->
    <template v-else-if="testingVal === 'Tooltip'">
      <div class="my-2">
        <h2>Tooltip</h2>
    ...
    <!-- Popover -->
    <template v-else-if="testingVal === 'Popover'">
      <div class="my-2">
        <h2>Popover</h2>
        <div class="d-flex gap-2">
          ...
          <b-button id="popover">Popover whith delay</b-button>
          <b-popover
            target="popover"
            :delay="{show: 2000, hide: 5000}"
            triggers="hover"
            placement="right"
          >
    ...
    <!-- Pagination -->
    <template v-else-if="testingVal === 'Pagination'">
      <div class="my-2">
        <h2>Pagination</h2>
        <div class="d-flex">
          <b-pagination
    ...
    <!-- Overlay -->
    <template v-else-if="testingVal === 'Overlay'">
      <div class="my-2">
        <h2>Overlay</h2>
        <div>
    ...
    <!-- List Group -->
    <template v-else-if="testingVal === 'List Group'">
      <div class="my-2">
        <h2>List Group</h2>
        <div>
          <b-list-group>
    ...
    <!-- Toast -->
    <template v-else-if="testingVal === 'Toast'">
      <p></p>
...
export default defineComponent({
  ...
  setup() {
    inject('toast')
    const testingVal = computed({
      get() {
        return sessionStorage.getItem('testingVal') || 'Form'
      },
      set(val: string) {
        sessionStorage.setItem('testingVal', val)
        return val
      },
    })
    const testingObj = ref([
      'Popover',
      'Form',
      'Navigation',
      'Badge',
