<template>
  <Teleport :to="props.teleportTo" :disabled="props.teleportDisabled">
    <BTransition
      :no-fade="true"
      v-bind="transProps"
      :trans-props="{...props.transProps?.transProps}"
...
import {computed, type CSSProperties, nextTick, onMounted, ref, toRef, watch} from 'vue'
import {
...
const {activePosition, activeModalCount} = useModalManager(showRef)
