...
describe('BFormCheckboxGroup with BApp global defaults', () => {
  describe('buttonVariant', () => {
    it('applies global.buttonVariant from BApp when set', () => {
      ...
      const TestComponent = defineComponent({
        ...
        template: '<BFormCheckboxGroup :options="options" buttons />',
      })
    ...
    it('explicit prop overrides BApp global and component defaults', () => {
      ...
      const TestComponent = defineComponent({
        ...
        template: '<BFormCheckboxGroup :options="options" buttons button-variant="success" />',
      })
  ...
  describe('state', () => {
    it('applies global.state from BApp when set', () => {
      ...
      const TestComponent = defineComponent({
        ...
        template: '<BFormCheckboxGroup :options="options" />',
      })
