...
describe('otp-input', () => {
  ...
  function getVisibleInputs(wrapper: ReturnType<typeof mount>) {
    return wrapper.findAll('.b-otp-input-field')
  }
  ...
  describe('rendering', () => {
    ...
    it('updates id when prop id changes', async () => {
      const wrapper = mount(BOtpInput, {props: {id: 'first'}})
    ...
    it('defaults to 6 visible input fields when length is 0', () => {
      const wrapper = mount(BOtpInput, {props: {length: 0}})
      expect(getVisibleInputs(wrapper)).toHaveLength(6)
    })
    ...
    it('accepts length as a string', () => {
      const wrapper = mount(BOtpInput, {props: {length: '4' as unknown as number}})
      expect(getVisibleInputs(wrapper)).toHaveLength(4)
    })
    ...
    it('all visible input fields have class b-otp-input-field', () => {
      const wrapper = mount(BOtpInput)
      const inputs = getVisibleInputs(wrapper)
      expect(inputs.length).toBeGreaterThan(0)
      for (const input of inputs) {
        expect(input.classes()).toContain('b-otp-input-field')
      }
    })
  ...
  describe('CSS classes', () => {
    it('has b-otp-input class', () => {
      const wrapper = mount(BOtpInput)
      expect(wrapper.classes()).toContain('b-otp-input')
    })
    ...
    it('does not have size class by default', () => {
      const wrapper = mount(BOtpInput)
      expect(wrapper.classes().some((c) => c.startsWith('b-otp-input-'))).toBe(false)
    })

    it('has b-otp-input-sm class when size is sm', () => {
      const wrapper = mount(BOtpInput, {props: {size: 'sm'}})
      expect(wrapper.classes()).toContain('b-otp-input-sm')
    })

    it('has b-otp-input-lg class when size is lg', () => {
      const wrapper = mount(BOtpInput, {props: {size: 'lg'}})
      expect(wrapper.classes()).toContain('b-otp-input-lg')
    })
    ...
    it('updates size class reactively', async () => {
      ...
      expect(wrapper.classes()).toContain('b-otp-input-lg')
      expect(wrapper.classes()).not.toContain('b-otp-input-sm')
    })
  ...
  describe('aria-label prop', () => {
    ...
    it('uses custom ariaLabel in aria-label attribute', () => {
      const wrapper = mount(BOtpInput, {props: {ariaLabel: 'OTP'}})
      const inputs = getVisibleInputs(wrapper)
    ...
    it('reflects custom length in aria-label', () => {
      const wrapper = mount(BOtpInput, {props: {length: 4, ariaLabel: 'Code'}})
      const inputs = getVisibleInputs(wrapper)
    ...
    it('updates aria-label reactively when ariaLabel changes', async () => {
      const wrapper = mount(BOtpInput, {props: {ariaLabel: 'Pin'}})
  ...
  describe('aria-invalid prop', () => {
    ...
    it('sets aria-invalid on all visible inputs when ariaInvalid is true', () => {
      const wrapper = mount(BOtpInput, {props: {ariaInvalid: true}})
      for (const input of getVisibleInputs(wrapper)) {
    ...
    it('sets aria-invalid to "grammar" on all visible inputs', () => {
      const wrapper = mount(BOtpInput, {props: {ariaInvalid: 'grammar'}})
      for (const input of getVisibleInputs(wrapper)) {
  ...
  describe('plaintext prop', () => {
    ...
    it('all visible input fields have form-control-plaintext class when plaintext is true', () => {
      const wrapper = mount(BOtpInput, {props: {plaintext: true}})
      for (const input of getVisibleInputs(wrapper)) {
  ...
  describe('readonly prop', () => {
    ...
    it('all visible input fields are readonly when readonly prop is true', () => {
      const wrapper = mount(BOtpInput, {props: {readonly: true}})
      for (const input of getVisibleInputs(wrapper)) {
        expect(input.attributes('readonly')).toBeDefined()
      }
    })
  ...
  describe('form prop', () => {
    ...
    it('all visible input fields have form attribute when form prop is set', () => {
      const wrapper = mount(BOtpInput, {props: {form: 'my-form'}})
      for (const input of getVisibleInputs(wrapper)) {
  ...
  describe('modelValue', () => {
    it('accepts an initial modelValue', () => {
      const wrapper = mount(BOtpInput, {props: {modelValue: ['1', '2', '3', '4', '5', '6']}})
      const inputs = getVisibleInputs(wrapper)
    ...
    it('accepts a partial modelValue', () => {
      const wrapper = mount(BOtpInput, {props: {modelValue: ['a', 'b']}})
      const inputs = getVisibleInputs(wrapper)
    ...
    it('sets the value on the hidden input element', () => {
      const wrapper = mount(BOtpInput, {props: {modelValue: ['a', 'b', 'c']}})
      const hiddenInput = getHiddenInput(wrapper)
  ...
  describe('name prop', () => {
    ...
    it('hidden input has the name from the prop', () => {
      const wrapper = mount(BOtpInput, {props: {name: 'otp-code'}})
      const hiddenInput = getHiddenInput(wrapper)
